 ...
 * @author crestas
 */
public class FrameLoginCliente extends javax.swing.JFrame {
    ...
    private void LoginAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginAdminActionPerformed
        // TODO add your handling code here:
        FrameLoginAdmin logAdmin = new FrameLoginAdmin();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameLoginCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameLoginCliente().setVisible(true);
            }
        });
    }
